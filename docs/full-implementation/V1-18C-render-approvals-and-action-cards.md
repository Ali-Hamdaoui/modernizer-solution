# [feat] Render approvals and action cards
...
## goal
> Deliver `V1-18C` by making `Render approvals and action cards` concrete in the files listed below, with focused tests and no adjacent V1 behavior.
...
## output contract
```text
Future PR for V1-18C changes only issue-owned implementation files, includes focused and affected regression evidence, and leaves unrelated deleted docs untouched.
```

## deps
| relation   | issue             |
| ---------- | ----------------- |
| blocked_by | `V1-17C,V1-07B` |
| blocks     | `V1-18D` |
