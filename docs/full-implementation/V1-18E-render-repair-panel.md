...
## goal
> Deliver `V1-18E` by making `Render repair panel` concrete in the files listed below, with focused tests and no adjacent V1 behavior.
...
## output contract
```text
Future PR for V1-18E changes only issue-owned implementation files, includes focused and affected regression evidence, and leaves unrelated deleted docs untouched.
```

## deps
| relation   | issue             |
| ---------- | ----------------- |
| blocked_by | `V1-14C,V1-15E` |
| blocks     | `V1-18F` |
