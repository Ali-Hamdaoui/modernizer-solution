# [feat] Render V1 job creation form
...
## goal
> Deliver `V1-18A` by making `Render V1 job creation form` concrete in the files listed below, with focused tests and no adjacent V1 behavior.
...
## output contract
```text
Future PR for V1-18A changes only issue-owned implementation files, includes focused and affected regression evidence, and leaves unrelated deleted docs untouched.
```

## deps
| relation   | issue             |
| ---------- | ----------------- |
| blocked_by | `V1-05,V1-09,V1-02` |
| blocks     | `V1-18B` |
