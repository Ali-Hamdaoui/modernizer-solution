# F15-JOB-064 — Add analysis explanation answer builder
...
Explain analysis artifacts in conversational language.
...
- [ ] Use analysis evidence pack.
- [ ] Answer risks/deps/tests/baseline questions.
- [ ] Do not execute.
...
- [ ] Answers cite artifact names.
- [ ] No invented findings.
- [ ] Missing evidence disclosed.

## Suggested tests

- `test_v2_assistant_analysis_explanation.py`
