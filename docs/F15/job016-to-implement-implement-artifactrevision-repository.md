# F15-JOB-016 — Implement ArtifactRevision repository
...
Persist artifact revisions without duplicating plan amendment storage.
...
- [ ] Add create/list/accept/supersede.
- [ ] Connect to artifact refs/checksums.
- [ ] Do not store raw artifact bodies.
...
- [ ] Accepted revision can be resolved.
- [ ] Supersede creates link.
