# F15-JOB-078 — Create analysis_review gate after Stage 3 analysis
...
Apply same analysis review behavior to Stage 3.
...
- [ ] Use accepted Stage 2 output.
- [ ] Bind Stage 3 analysis artifacts.
- [ ] Prepare final-stage context.
...
- [ ] Stage 3 planning waits.
- [ ] Stage 3 uses Stage 2 output.
- [ ] No direct Stage 3 jump.

## Suggested tests

- `test_v2_stage3_analysis_review_gate.py`
