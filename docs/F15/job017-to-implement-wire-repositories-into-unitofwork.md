# F15-JOB-017 — Wire repositories into UnitOfWork
...
Expose new repositories via the existing SQLite unit of work.
...
- [ ] Update UoW factory.
- [ ] Add properties for gates/decisions/revisions.
- [ ] Preserve existing UoW tests.
...
- [ ] New repos share transaction boundary.
- [ ] No breaking constructor signature unless backward-compatible.

## Suggested tests

- `test_sqlite_uow_read_mode.py`
