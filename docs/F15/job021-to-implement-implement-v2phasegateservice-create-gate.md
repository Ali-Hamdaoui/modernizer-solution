# F15-JOB-021 — Implement V2PhaseGateService create gate
...
Create gates from validated phase outcomes.
...
- [ ] Add v2_phase_gate_service.py.
- [ ] Implement create_gate with checksum generation.
- [ ] Reject duplicate open gate unless superseding.
...
- [ ] Gate contains frozen artifact refs.
- [ ] Gate checksum is returned.
- [ ] Duplicate open gate is handled safely.

## Suggested tests

- `test_v2_phase_gate_service.py`
