# F15-JOB-044 — Add repair gate creation hook
...
Create repair_review gate when build/test/transform fails.
...
- [ ] Use failure diagnosis evidence.
- [ ] Use V2RepairFlowService proposal.
- [ ] Bind patch preview/reviewer status.
...
- [ ] Failure does not auto-apply repair.
- [ ] Repair gate has proposal refs.
- [ ] Gate available actions are correct.
