# F15-JOB-034 — Implement gate actor model
...
Track whether decision came from user, assistant draft, API, or system.
...
- [ ] Define actor enum.
- [ ] Persist actor/source.
- [ ] Make assistant non-authoritative unless user-confirmed.
