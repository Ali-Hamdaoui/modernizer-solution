# F15-JOB-105 — Implement approve_repair action
...
Apply approved repair in sandbox through existing repair flow.
...
- [ ] Validate gate checksum.
- [ ] Validate repair approval checksum.
- [ ] Call V2RepairFlowService.apply_patch or action path.
...
- [ ] Validation rerun queued/started.

## Suggested tests

- `test_v2_approve_repair_action.py`
