# F15-JOB-088 — Create planning_review gate after Stage 3 planning
...
Apply planning review to Stage 3.
...
- [ ] Bind Stage 3 plan artifacts.
- [ ] Use accepted Stage 3 analysis.
- [ ] Create gate.
...
- [ ] Stage 3 approval waits.
- [ ] Final-stage plan visible.
- [ ] No direct transform.

## Suggested tests

- `test_v2_stage3_planning_review_gate.py`
