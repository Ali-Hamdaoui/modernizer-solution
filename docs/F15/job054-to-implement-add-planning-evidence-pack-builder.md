# F15-JOB-054 — Add planning evidence pack builder
...
Build bounded evidence packs from planning artifacts.
...
- [ ] Read migration_plan, migration_units, approval_request.
- [ ] Extract units/risk/commands.
- [ ] Redact paths.
...
- [ ] Pack supports plan Q&A.
- [ ] Large YAML is summarized safely.
- [ ] No stale preview.

## Suggested tests

- `test_v2_planning_evidence_pack.py`
