# F15-JOB-009 — Create F15 implementation guardrails
...
Write implementation rules so subagents do not duplicate existing logic.
...
- [ ] List existing services to reuse.
- [ ] List files not to fork.
- [ ] List forbidden frontend/chatbot fields.
...
- [ ] Guardrails include no sandbox_path in new actions.
- [ ] Guardrails mention repair and plan reuse.
- [ ] Guardrails mention artifact truth rule.
