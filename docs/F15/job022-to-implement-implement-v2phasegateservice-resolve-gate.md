# F15-JOB-022 — Implement V2PhaseGateService resolve gate
...
Resolve open gates through append-only decisions.
...
- [ ] Resolved gate cannot resolve again with different outcome.
- [ ] Decision record is persisted.

## Suggested tests

- `test_v2_phase_gate_actions.py`
