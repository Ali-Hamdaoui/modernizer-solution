# F15-JOB-006 — Create F15 architecture decision note
...
Capture the architecture choice: flexible chatbot + strict backend gate engine.
...
- [ ] Write ADR or doc section.
- [ ] Compare phase-split commands vs LangGraph interrupts.
- [ ] Record first implementation chooses phase-split commands.
...
- [ ] Doc names current repo constraints.
- [ ] Doc explains why no direct Stage 3 jump.
- [ ] Doc lists reuse targets.
