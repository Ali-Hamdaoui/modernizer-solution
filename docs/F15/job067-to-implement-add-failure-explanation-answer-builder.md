# F15-JOB-067 — Add failure explanation answer builder
...
Explain build/test failure and proposed repair.
...
- [ ] Use failure evidence pack.
- [ ] Summarize root-cause hypothesis.
- [ ] Show repair approval options.
...
- [ ] No repair applied in explanation.
- [ ] Patch preview is bounded/redacted.
- [ ] Unsafe proposal warnings shown.

## Suggested tests

- `test_v2_assistant_failure_explanation.py`
