# F15-JOB-114 — Keep old stage progression endpoint compatible
...
Do not break existing stage progression endpoint while adding F15 APIs.

## Existing repo pieces to inspect/reuse

- `migration_factory/control_tower/adapters/fastapi/app.py; web/control-tower/app/migrations/[jobId]/MigrationCockpit.tsx`
...
- [ ] Leave endpoint in place.
- [ ] Mark not used by F15 chatbot path.
...
- [ ] Old endpoint behavior still passes.
- [ ] F15 endpoint is safer.
- [ ] Docs warn against frontend path in F15.

## Suggested tests

- `test_v2_stage_progression_compat_api.py`
