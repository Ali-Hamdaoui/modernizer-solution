# F15-JOB-096 — Add approval summary UI card
...
Render approval gate and checksum-bound approval button.
...
- [ ] Show accepted analysis/plan checksums.
- [ ] Show scope/risk/validation plan.
- [ ] Post approve action.
...
- [ ] No sandbox path sent.
- [ ] Rejection path visible.

## Suggested tests

- `MigrationCockpit approval gate tests`
