# F15-JOB-056 — Add failure evidence pack builder
...
Build repair/failure evidence packs from logs and diagnosis.
...
- [ ] Read failed command refs.
- [ ] Collect logs/test reports/classification.
...
- [ ] Pack supports failure explanation.
- [ ] Sensitive env not exposed.
- [ ] Missing logs handled safely.

## Suggested tests

- `test_v2_failure_evidence_pack.py`
