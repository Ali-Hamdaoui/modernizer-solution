# F15-JOB-098 — Add planning revision adapter
...
Create V2 adapter around existing V1 plan amendment/revision services.
...
- [ ] Wrap PlanAmendmentService.
- [ ] Translate V2 job/stage context.
...
- [ ] Existing plan services reused.
- [ ] V2 gate references revisions.
- [ ] No parallel revision tables unless justified.

## Suggested tests

- `test_v2_plan_revision_adapter.py`
