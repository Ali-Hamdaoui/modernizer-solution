# F15-JOB-100 — Add approval runbook
...
Document approval summary, checksums, and rejection/revision paths.
...
- [ ] Describe exact approval semantics.
- [ ] Explain checksum mismatch.
- [ ] Explain plan revision after approval.
...
- [ ] Runbook is usable by dev/operator.
- [ ] Mentions no direct LLM approval.
- [ ] Lists tests.
