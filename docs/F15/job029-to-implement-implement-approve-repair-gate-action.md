# F15-JOB-029 — Implement approve_repair gate action
...
Apply repair only through existing V2RepairFlowService after approval.
...
- [ ] Add handler calling V2RepairFlowService.
- [ ] Validate proposal and reviewer state.
- [ ] Run sandbox-only apply.
...
- [ ] Repair apply requires approval checksum.
- [ ] Legacy source not mutated.
- [ ] Result links to repair_id.

## Suggested tests

- `test_v2_repair_review_gate.py`
