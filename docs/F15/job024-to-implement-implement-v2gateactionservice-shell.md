# F15-JOB-024 — Implement V2GateActionService shell
...
Centralize state-changing gate actions.
...
- [ ] Add v2_gate_action_service.py.
- [ ] Implement common validation pipeline.
- [ ] No command launch in initial skeleton.
...
- [ ] Reject closed/missing gates.
- [ ] Reject phase/action mismatch.
- [ ] Reject frontend paths.

## Suggested tests

- `test_v2_gate_actions.py`
