# F15-JOB-046 — Add gate-driven command manifests
...
Ensure commands launched from gates reference gate/decision ids.
...
- [ ] Add gate_id/decision_id to command payload/metadata.
- [ ] Preserve existing command schema compatibility.
- [ ] Emit events.
...
- [ ] Command can be traced to decision.
- [ ] Old commands still display.
- [ ] No secrets/paths exposed.

## Suggested tests

- `test_v2_gate_command_manifest.py`
