# F15-JOB-035 — Implement gate error taxonomy
...
Return typed, safe errors for invalid gate actions.
...
- [ ] Missing gate -> 404/typed.
- [ ] Closed gate -> 409.
- [ ] Unsafe field -> 422.

## Suggested tests

- `test_v2_gate_errors.py`
