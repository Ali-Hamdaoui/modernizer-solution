# F15-JOB-093 — Create approval_review gate
...
Generate checksum-bound approval summary after accepted plan.
...
- [ ] Bind accepted analysis/plan revisions.
- [ ] Include migration units and validation plan.
- [ ] Create gate.
...
- [ ] Gate checksum covers approved scope.
- [ ] Transform blocked before approval.
- [ ] Summary explains risks.

## Suggested tests

- `test_v2_approval_gate.py`
