# F15-JOB-019 — Add gate projection DTOs
...
Create API-safe DTOs for gates and decisions.
...
- [ ] Define GateDTO, GateDecisionDTO, ArtifactRevisionDTO.
- [ ] Redact path-like values.
- [ ] Expose checksums and statuses.
...
- [ ] DTO contains no raw absolute paths.
- [ ] DTO includes available_actions.
- [ ] DTO is stable for frontend.

## Suggested tests

- `test_v2_gate_contracts.py`
