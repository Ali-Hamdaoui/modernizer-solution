# F15-JOB-057 — Add artifact resolver failure messages
...
Return exact sanitized reasons when evidence cannot be read.
...
- [ ] Missing artifact does not hallucinate.
- [ ] Checksum mismatch blocks answer.
- [ ] Reason is sanitized.

## Suggested tests

- `test_v2_artifact_resolver_failures.py`
