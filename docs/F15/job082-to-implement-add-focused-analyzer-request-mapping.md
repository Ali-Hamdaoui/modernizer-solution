# F15-JOB-082 — Add focused analyzer request mapping
...
Map user comments to focused analysis scopes safely.
...
- [ ] Define allowed scopes: dependencies, imports, XML, tests, security, internal jars.
- [ ] Reject arbitrary scripts.
- [ ] Queue backend analyzer.
...
- [ ] "check XML" maps to XML scan.
- [ ] Unknown scope asks clarifying question.
- [ ] No shell command from user.

## Suggested tests

- `test_v2_analysis_scope_mapping.py`
