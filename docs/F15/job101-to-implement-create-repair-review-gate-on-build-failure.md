# F15-JOB-101 — Create repair_review gate on build failure
...
Stop failed stage and show repair proposal before any apply.
...
- [ ] Hook build/test failure.
- [ ] Use failure diagnosis.
- [ ] Create repair proposal through existing service.
...
- [ ] Repair gate created.
- [ ] Failure evidence bound.

## Suggested tests

- `test_v2_repair_gate_on_build_failure.py`
