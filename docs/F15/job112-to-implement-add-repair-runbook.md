# F15-JOB-112 — Add repair runbook
...
Document repair review and approval workflow.
...
- [ ] Explain proposal/reviewer/approval/apply/validation.
- [ ] Explain attempt limits and rollback.
- [ ] List tests.
...
- [ ] Runbook references existing V2RepairFlowService.
- [ ] No duplicate engine instructions.
