# F15-JOB-111 — Add repair assistant Q&A
...
Let chatbot explain failures and repair proposals flexibly.
...
- [ ] Use repair evidence pack.
- [ ] Explain root cause and patch risk.
- [ ] Handle user repair changes.
...
- [ ] No apply during explanation.
- [ ] Revision request is typed.
- [ ] Unsafe user instruction blocked.

## Suggested tests

- `test_v2_assistant_repair_qa.py`
