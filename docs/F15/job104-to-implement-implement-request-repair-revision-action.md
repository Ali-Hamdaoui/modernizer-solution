# F15-JOB-104 — Implement request_repair_revision action
...
Let user ask for a modified repair proposal.
...
- [ ] Call existing revise_repair_proposal path.
- [ ] Store user constraints.
- [ ] Create replacement repair gate.
...
- [ ] New proposal references user feedback.
- [ ] No patch applied.

## Suggested tests

- `test_v2_repair_revision_request.py`
