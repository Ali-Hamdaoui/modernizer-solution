# F15-JOB-062 — Add gate-aware assistant context loader
...
Load current open gate and evidence pack for assistant Q&A.
...
- [ ] Extend V2AssistantService or compose helper.
- [ ] Load gate by job_id.
...
- [ ] Assistant knows current gate.
- [ ] No gate -> normal assistant behavior.
- [ ] Evidence is gate-bound.

## Suggested tests

- `test_v2_assistant_gate_context.py`
