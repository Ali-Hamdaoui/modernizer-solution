# F15-JOB-116 — Add MigrationCockpit open gate panel
...
Show the current required review gate in the cockpit.
...
- [ ] User sees current stop reason.
- [ ] Actions call gate API.
- [ ] No duplicate old panels.

## Suggested tests

- `MigrationCockpit gate panel tests`
