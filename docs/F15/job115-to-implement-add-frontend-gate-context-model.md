# F15-JOB-115 — Add frontend gate context model
...
Add TypeScript contracts for gates/actions.
...
- [ ] Update contracts.ts.
- [ ] Add controlTowerApi gate calls.
- [ ] No sandbox_path in action body.
...
- [ ] Typecheck passes.
- [ ] Gate action body safe.
- [ ] Existing UI contracts intact.
