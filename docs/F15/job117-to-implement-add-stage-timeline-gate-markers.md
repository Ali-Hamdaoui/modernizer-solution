# F15-JOB-117 — Add stage timeline gate markers
...
Visualize gates in the existing stage timeline.
...
- [ ] Add markers for analysis/planning/approval/repair/stage completion.
- [ ] Reuse existing timeline components.
- [ ] Avoid new standalone timeline.
...
- [ ] Gate markers appear by stage.
- [ ] Resolved/superseded status shown.
- [ ] Old timeline still works.
