# F15-JOB-059 — Add bounded context budget for gate packs
...
Prevent oversized artifacts from bloating assistant prompts.
...
- [ ] Add token/char budget.
- [ ] Prefer structured summary.
- [ ] Expose truncation marker accurately.
...
- [ ] Assistant never calls excerpt full.
- [ ] Budget enforced.
- [ ] Critical fields preserved.

## Suggested tests

- `test_v2_gate_context_budget.py`
