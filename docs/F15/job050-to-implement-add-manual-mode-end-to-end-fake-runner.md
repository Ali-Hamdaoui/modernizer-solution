# F15-JOB-050 — Add manual mode end-to-end fake runner
...
Prove first demo flow without real Maven cost.
...
- [ ] Use fake runner outputs.
- [ ] Stage 1 analysis creates gate.
- [ ] Continue queues planning.
...
- [ ] Analysis stops.
- [ ] Chatbot explanation can read gate.
- [ ] Continue starts planning command.

## Suggested tests

- `test_v2_f15_first_slice_e2e.py`
