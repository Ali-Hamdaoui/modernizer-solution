# F15-JOB-075 — Add assistant UX copy and examples
...
Document flexible phrases and expected mappings.
...
- [ ] Examples for continue/reanalysis/plan revision/approval/repair.
...
- [ ] Docs show flexibility.
- [ ] Docs stress backend validation.
- [ ] No phrase-only implementation implied.
