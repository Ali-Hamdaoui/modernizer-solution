# F15-JOB-049 — Add legacy auto behavior regression tests
...
Protect old behavior while F15 is opt-in.
...
- [ ] Create tests with auto_on_green policy.
- [ ] Assert _auto_queue_next_stage behavior remains.
- [ ] Assert no gate blocks old jobs.
...
- [ ] Stage 2 auto queues Stage 3.
- [ ] Manual mode test separate.

## Suggested tests

- `test_v2_auto_policy_regression.py`
