# F15-JOB-060 — Add artifact truth regression from F14
...
Prevent stale-preview behavior from spreading to F15.
...
- [ ] Create fixture where preview is stale but gate ref is correct.
- [ ] Assert gate answer uses ref.
- [ ] No fallback to old preview.
...
- [ ] Gate resolver chooses live/frozen ref.
- [ ] Stale preview ignored.
- [ ] Failure reason visible if ref broken.

## Suggested tests

- `test_v2_gate_artifact_truth_regression.py`
