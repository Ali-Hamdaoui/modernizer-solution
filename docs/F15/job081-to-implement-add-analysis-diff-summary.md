# F15-JOB-081 — Add analysis diff summary
...
Show what changed after re-analysis.
...
- [ ] Compare artifact summaries.
- [ ] Highlight added/removed findings.
- [ ] Bind new revision.
...
- [ ] Diff generated.
- [ ] No full raw sensitive content leaked.
- [ ] User can accept new revision.

## Suggested tests

- `test_v2_analysis_diff_summary.py`
