# F15-JOB-107 — Add repair validation result gate transition
...
After repair validation, route to completion or another repair gate.
...
- [ ] If pass create stage_completion_review.
- [ ] If fail create new repair gate or exhausted status.
- [ ] Link validation id.
...
- [ ] Pass moves forward.
- [ ] Fail does not loop infinitely.
- [ ] Attempt limits honored.

## Suggested tests

- `test_v2_repair_validation_transition.py`
