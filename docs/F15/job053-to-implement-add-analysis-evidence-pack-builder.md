# F15-JOB-053 — Add analysis evidence pack builder
...
Build bounded evidence packs from analysis artifacts.
...
- [ ] Read analysis_report, dependency_graph, test_inventory, read_only_verification.
...
- [ ] Pack includes major findings.
- [ ] Pack is bounded in size.
- [ ] No raw secrets.

## Suggested tests

- `test_v2_analysis_evidence_pack.py`
