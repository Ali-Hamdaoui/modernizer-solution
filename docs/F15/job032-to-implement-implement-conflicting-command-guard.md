# F15-JOB-032 — Implement conflicting command guard
...
Prevent two commands from being queued for one open gate.
...
- [ ] Check command repo for running/queued work.
- [ ] Reject or idempotently return existing command.
- [ ] Cover race-like tests.
