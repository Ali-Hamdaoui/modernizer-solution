# F15-JOB-007 — Define gate checksum contract
...
Standardize how gate checksums bind artifact refs, phase, stage, and required action.
...
- [ ] Create canonical JSON checksum helper or reuse existing canonical_json_text helpers.
- [ ] Define fields included in gate checksum.
...
- [ ] Checksum changes when artifact refs change.
- [ ] Checksum changes when phase/stage changes.
- [ ] Approval with stale checksum fails.

## Suggested tests

- `test_v2_gate_checksum.py`
