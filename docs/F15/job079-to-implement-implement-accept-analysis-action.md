# F15-JOB-079 — Implement accept_analysis action
...
Resolve analysis gate and allow planning to run.
...
- [ ] Mark analysis revision accepted.
- [ ] Queue planning phase.
...
- [ ] Planning consumes accepted analysis.
- [ ] Duplicate accept idempotent.
- [ ] Wrong stage blocked.

## Suggested tests

- `test_v2_accept_analysis_action.py`
