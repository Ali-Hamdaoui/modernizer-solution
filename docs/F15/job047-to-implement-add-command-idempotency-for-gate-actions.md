# F15-JOB-047 — Add command idempotency for gate actions
...
Prevent duplicate phase/stage commands from repeated chatbot/user actions.
...
- [ ] Lookup decision by idempotency key.
- [ ] Return existing command if already queued.
- [ ] Reject mismatch.
...
- [ ] Double click continue queues once.
- [ ] Retry after network loss is safe.
- [ ] Mismatch is 409.
