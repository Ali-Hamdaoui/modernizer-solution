# F15-JOB-106 — Implement reject_repair action
...
Let user reject repair without side effects.
...
- [ ] Persist rejection.
- [ ] Leave stage failed/blocked.
- [ ] Allow future alternate repair request if policy permits.
...
- `test_v2_reject_repair_action.py`
