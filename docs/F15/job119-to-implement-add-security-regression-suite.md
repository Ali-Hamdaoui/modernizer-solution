# F15-JOB-119 — Add security regression suite
...
- [ ] Test sandbox_path rejection.
- [ ] Test prompt injection artifact.
- [ ] Test direct command blocked.
...
- [ ] No paths/argv/env accepted.
- [ ] Artifact instructions ignored.
- [ ] Blocked actions rejected.

## Suggested tests

- `test_v2_gate_security.py`
