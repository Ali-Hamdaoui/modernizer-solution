# F15-JOB-041 — Add analysis completion hook
...
Detect analysis completion and create analysis_review gate under manual policy.
...
- [ ] Hook event/result processing.
- [ ] Gather artifact refs.
- [ ] Create gate before planning starts.
...
- [ ] analysis_review gate created.
- [ ] Planning not launched before accept.
- [ ] Artifacts are checksum-bound.

## Suggested tests

- `test_v2_analysis_review_gate.py`
