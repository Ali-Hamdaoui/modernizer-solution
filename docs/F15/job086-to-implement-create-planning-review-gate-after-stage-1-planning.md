# F15-JOB-086 — Create planning_review gate after Stage 1 planning
...
Stop Stage 1 after planning in F15 manual mode.
...
- [ ] Detect planning completion.
- [ ] Bind migration_plan/migration_units/approval_request.
- [ ] Create gate.
...
- [ ] Approval not started before accepted plan.
- [ ] Chatbot explains plan.
- [ ] Plan revision possible.

## Suggested tests

- `test_v2_stage1_planning_review_gate.py`
