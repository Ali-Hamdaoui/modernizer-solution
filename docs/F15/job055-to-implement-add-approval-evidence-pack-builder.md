# F15-JOB-055 — Add approval evidence pack builder
...
Build approval summary from checksum-bound accepted revisions.
...
- [ ] Include accepted analysis/plan refs.
- [ ] Include risk and source-changing scope.
- [ ] Include approval checksum.
...
- [ ] Approval summary matches gate checksum.
- [ ] No transform before approval.
- [ ] UI receives safe payload.

## Suggested tests

- `test_v2_approval_evidence_pack.py`
