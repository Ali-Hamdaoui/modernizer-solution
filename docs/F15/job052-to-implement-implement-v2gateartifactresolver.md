# F15-JOB-052 — Implement V2GateArtifactResolver
...
Resolve gate-bound evidence safely for assistant and UI.
...
- [ ] Read refs from gate.
- [ ] Verify checksums before returning content.
...
- [ ] Stale previews ignored.
- [ ] Checksum mismatch returns safe failure.
- [ ] Resolver never uses frontend path.

## Suggested tests

- `test_v2_gate_artifact_resolution.py`
