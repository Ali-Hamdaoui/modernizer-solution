# F15-JOB-074 — Add multi-stage assistant context switching
...
Let chatbot answer about Stage 1/2/3 gates without confusion.
...
- [ ] Support stage selector.
- [ ] Default to current open gate.
- [ ] Block stale stage actions.
...
- [ ] Stage-specific questions answer correct artifacts.
- [ ] Cannot approve Stage 2 gate from Stage 1 context.
- [ ] Current gate displayed.

## Suggested tests

- `test_v2_assistant_multistage_context.py`
