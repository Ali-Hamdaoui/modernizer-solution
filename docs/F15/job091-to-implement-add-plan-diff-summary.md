# F15-JOB-091 — Add plan diff summary
...
Show what changed between plan revisions.
...
- [ ] Compare migration units.
- [ ] Compare risk summary.
- [ ] Explain accepted/rejected changes.
...
- [ ] Diff is visible to user.
- [ ] No raw path leak.
- [ ] Accepted revision is explicit.

## Suggested tests

- `test_v2_plan_diff_summary.py`
