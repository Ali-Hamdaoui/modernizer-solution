# F15-JOB-058 — Add redaction filters for gate packs
...
Apply existing redaction policy to gate evidence.
...
- [ ] Reuse existing redaction utilities.
- [ ] Filter URLs/secrets/absolute paths.
...
- [ ] Secrets redacted.
- [ ] Absolute paths redacted in public response.
- [ ] Internal repo URLs not leaked.

## Suggested tests

- `test_v2_gate_redaction.py`
