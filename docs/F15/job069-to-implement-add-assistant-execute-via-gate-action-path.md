# F15-JOB-069 — Add assistant execute-via-gate action path
...
Allow confirmed user message to call backend gate action service.
...
- [ ] Assistant route calls V2GateActionService only.
- [ ] No direct command launch.
...
- [ ] Continue goes through gate service.
- [ ] Wrong checksum rejected.
- [ ] No sandbox_path accepted.

## Suggested tests

- `test_v2_assistant_gate_action_execute.py`
