# F15-JOB-037 — Resolve next stage from persisted output
...
Remove reliance on frontend/chatbot-supplied sandbox_path for F15 progression.
...
- [ ] Add backend resolver for prior-stage output.
- [ ] Use command/event/output registry evidence.
- [ ] Keep old endpoint compatibility isolated.
...
- [ ] F15 path accepts no sandbox_path.
- [ ] Stage 2 consumes accepted Stage 1 output.
- [ ] Stage 3 consumes accepted Stage 2 output.

## Suggested tests

- `test_v2_stage_output_resolver.py`
