# F15-JOB-070 — Add ambiguity handling rules
...
Avoid unsafe action on vague user text.
...
- [ ] "looks okay" asks/clarifies or offers continue.
- [ ] "fix it" clarifies repair vs reanalysis.
- [ ] No state change without valid action.

## Suggested tests

- `test_v2_assistant_gate_ambiguity.py`
