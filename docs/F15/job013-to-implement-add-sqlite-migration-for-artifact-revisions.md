# F15-JOB-013 — Add SQLite migration for artifact revisions
...
Persist accepted/superseded artifact revisions.
...
- [ ] Create `v2_artifact_revisions`.
- [ ] Support revision_kind and base_revision_id.
- [ ] Support accepted_at/status fields.
...
- [ ] Revision refs are immutable.
- [ ] Accepted revision can be looked up by job/stage/kind.
- [ ] Superseded revision remains accessible.

## Suggested tests

- `test_v2_artifact_revision_repository.py`
