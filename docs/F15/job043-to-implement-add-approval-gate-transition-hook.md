# F15-JOB-043 — Add approval gate transition hook
...
Create approval gate after accepted plan.
...
- [ ] Bind approval_request and plan checksum.
- [ ] Block transform until approval action.
...
- [ ] Transform not queued automatically.
- [ ] Checksum approval required.
