# F15-JOB-025 — Implement continue_from_gate validation
...
Validate continue decisions before queuing next backend work.
...
- [ ] Add action handler.
- [ ] Require gate checksum.
- [ ] Require allowed phase transition.
...
- [ ] Continue is accepted only on open compatible gate.
- [ ] Duplicate continue is idempotent.
- [ ] No direct command data accepted.

## Suggested tests

- `test_v2_continue_from_gate.py`
