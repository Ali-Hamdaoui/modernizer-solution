# F15-JOB-039 — Add warning-sensitive policy mode
...
Support manual_on_warning_or_failure for teams that want selective stops.
...
- [ ] Detect warnings/failures/open repairs.
- [ ] Auto-progress only clean green result.
- [ ] Create gate otherwise.
...
- [ ] Clean stage can auto-progress.
- [ ] Warning stage creates gate.
- [ ] Failure stage creates repair gate.

## Suggested tests

- `test_v2_stage_policy_warnings.py`
