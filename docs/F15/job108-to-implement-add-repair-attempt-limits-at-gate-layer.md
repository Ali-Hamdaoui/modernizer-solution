# F15-JOB-108 — Add repair attempt limits at gate layer
...
Prevent endless repair loops or high-risk repeated changes.
...
- [ ] Use existing attempt limits if present.
- [ ] Expose remaining attempts.
- [ ] Block after limit.
...
- [ ] Limit block is clear.
- [ ] No new repair after exhausted.

## Suggested tests

- `test_v2_repair_attempt_limits.py`
