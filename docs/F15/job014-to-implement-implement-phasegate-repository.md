# F15-JOB-014 — Implement PhaseGate repository
...
Provide repository methods for gates through existing SQLite/UoW patterns.
...
- [ ] Add create/get/list/update_status methods.
- [ ] Integrate with unit_of_work.
- [ ] Return domain records, not raw rows.
...
- [ ] Repository participates in UoW.
- [ ] No commits outside UoW contract.
- [ ] Missing gate returns None/typed error.

## Suggested tests

- `test_v2_phase_gate_repository.py`
