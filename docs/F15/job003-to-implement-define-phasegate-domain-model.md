# F15-JOB-003 — Define PhaseGate domain model
...
Create the durable wait-state object used by analysis, planning, approval, repair, and stage-completion gates.
...
- [ ] Add PhaseGate dataclass/entity.
- [ ] Add gate phase/status/decision enums.
- [ ] Add checksum fields and source artifact refs.
...
- [ ] PhaseGate supports stage 1/2/3.
- [ ] Resolved gates are immutable in service contract.
- [ ] Open gate uniqueness is expressible.

## Suggested tests

- `test_v2_phase_gates.py`
