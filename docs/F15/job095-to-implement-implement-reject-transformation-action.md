# F15-JOB-095 — Implement reject_transformation action
...
Allow user to reject approval gate safely.
...
- [ ] Gate rejected.
- [ ] Job waits/blocked.
- [ ] User can request plan revision if allowed.

## Suggested tests

- `test_v2_reject_transformation_action.py`
