# F15-JOB-094 — Implement approve_transformation action
...
Queue transformation only through approved gate.
...
- [ ] Validate approval checksum.
- [ ] Record decision.
- [ ] Queue transform/build/test command.
...
- [ ] No transform without approval.
- [ ] Wrong checksum blocked.
- [ ] No frontend path.

## Suggested tests

- `test_v2_approve_transformation_action.py`
