# F15-JOB-033 — Implement gate checksum stale protection
...
Block actions against stale UI/chatbot views.
...
- [ ] Compare expected_gate_checksum to current.
- [ ] Return current gate projection on mismatch.
- [ ] Log audit event.
...
- [ ] Stale checksum cannot approve.
- [ ] Response explains refresh needed.
- [ ] No side effects happen.

## Suggested tests

- `test_v2_gate_stale_checksum.py`
