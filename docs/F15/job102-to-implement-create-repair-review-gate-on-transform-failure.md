# F15-JOB-102 — Create repair_review gate on transform failure
...
Handle transformation failures with same repair gate pattern.
...
- [ ] Hook transform failure.
- [ ] Create diagnosis/proposal if repairable.
- [ ] Block if not repairable.
...
- [ ] Repairable transform failure creates gate.
- [ ] Unrepairable failure explains reason.
- [ ] No source mutation.

## Suggested tests

- `test_v2_repair_gate_on_transform_failure.py`
