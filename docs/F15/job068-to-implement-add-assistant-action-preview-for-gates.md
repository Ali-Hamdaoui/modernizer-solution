# F15-JOB-068 — Add assistant action preview for gates
...
Let chatbot draft a gate action before backend execution.
...
- [ ] Return candidate action JSON.
- [ ] Show confidence and extracted constraints.
- [ ] Require user confirmation if needed.
...
- [ ] Draft action is non-executing.
- [ ] Dangerous fields excluded.
- [ ] Low confidence asks question.

## Suggested tests

- `test_v2_assistant_gate_action_preview.py`
