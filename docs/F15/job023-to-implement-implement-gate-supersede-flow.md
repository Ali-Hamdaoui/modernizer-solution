# F15-JOB-023 — Implement gate supersede flow
...
Support re-analysis and plan revision by superseding old gates.
...
- [ ] Implement supersede_gate.
- [ ] Link old/new gate.
- [ ] Preserve old artifact refs.
...
- [ ] Old gate becomes superseded.
- [ ] New gate is open.
- [ ] Old gate decisions remain readable.

## Suggested tests

- `test_v2_gate_supersede.py`
