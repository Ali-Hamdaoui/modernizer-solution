# F15-JOB-048 — Add gate-aware event sink
...
Emit lifecycle events for UI and assistant context.
...
- [ ] Emit gate_opened/resolved/superseded.
- [ ] Include stage and phase.
- [ ] Avoid raw paths.
...
- [ ] SSE shows open gate.
- [ ] Assistant can query latest gate.
- [ ] Existing clients tolerate event.
