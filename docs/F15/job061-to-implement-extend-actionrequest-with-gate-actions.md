# F15-JOB-061 — Extend ActionRequest with gate actions
...
Add gate-aware allowed action types without unblocking dangerous actions.
...
- [ ] Update v2_model_schemas.py.
- [ ] Add continue_from_gate/request_reanalysis/request_plan_revision/etc.
- [ ] Keep blocked action list.
...
- [ ] Blocked actions still rejected.
- [ ] Gate actions validate schema.
- [ ] No approve_decision_without_gate.

## Suggested tests

- `test_v2_assistant_gate_actions_schema.py`
