# F15-JOB-010 — Create F15 compatibility matrix
...
- [ ] Matrix for auto_on_green/manual/manual_on_warning_or_failure.
- [ ] Matrix for old endpoints/new endpoints.
- [ ] Matrix for Stage 1/2/3.
...
- [ ] Old default remains compatible.
- [ ] F15 mode is opt-in.
- [ ] Migration strategy is explicit.

## Suggested tests

- `test_v2_f15_compatibility.py`
