# F15-JOB-027 — Implement request_plan_revision validation
...
Convert user plan feedback into existing plan amendment/revision flow.
...
- [ ] Add handler that calls PlanAmendmentService adapter.
- [ ] Bind accepted analysis revision.
- [ ] Supersede planning gate.
...
- [ ] Only planning/approval phases allow action.
- [ ] Plan revision does not edit YAML directly.
- [ ] New planning gate is created.

## Suggested tests

- `test_v2_plan_revision_request.py`
