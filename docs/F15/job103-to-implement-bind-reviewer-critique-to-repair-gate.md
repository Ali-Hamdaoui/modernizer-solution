# F15-JOB-103 — Bind reviewer critique to repair gate
...
Require latest reviewer critique before repair approval.
...
- [ ] Use V2RepairFlowService reviewer gate.
- [ ] Bind proposal checksum and critique checksum.
- [ ] Expose status.
...
- [ ] Approval blocked without required critique.
- [ ] Outdated critique rejected.
- [ ] Critique shown in gate.

## Suggested tests

- `test_v2_repair_reviewer_gate.py`
