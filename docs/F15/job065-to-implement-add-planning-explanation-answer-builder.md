# F15-JOB-065 — Add planning explanation answer builder
...
Explain migration plan and units flexibly.
...
- [ ] Use planning evidence pack.
- [ ] Explain order/risk/affected areas.
- [ ] Handle plan-change suggestions.
...
- [ ] Explains plan without applying changes.
- [ ] Can draft revision request.
- [ ] No YAML direct edit.

## Suggested tests

- `test_v2_assistant_planning_explanation.py`
