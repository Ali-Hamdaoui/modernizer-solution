# F15-JOB-110 — Add repair UI card
...
Render failure diagnosis and repair approval/revision actions.
...
- [ ] Show patch preview and reviewer critique.
- [ ] Buttons approve/revise/reject.
...
- [ ] No patch apply without gate action.
- [ ] No raw paths sent.
- [ ] Chatbot context is repair gate.

## Suggested tests

- `MigrationCockpit repair gate tests`
