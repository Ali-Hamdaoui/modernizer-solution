# F15-JOB-090 — Implement request_plan_revision action
...
Reuse existing plan amendment/revision flow from F15.
...
- [ ] Create amendment via existing service.
- [ ] Generate revision proposal.
...
- [ ] No direct YAML edit.
- [ ] New gate references revision.
- [ ] Approval invalid if old plan changes.

## Suggested tests

- `test_v2_request_plan_revision.py`
