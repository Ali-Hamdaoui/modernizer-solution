# F15-JOB-005 — Define artifact revision model
...
Version analysis, planning, approval, and repair evidence so downstream phases consume accepted revisions only.
...
- [ ] Add revision entity.
- [ ] Support analysis/planning/approval/repair kinds.
- [ ] Bind artifact refs and checksums.
...
- [ ] Planning cannot consume unaccepted analysis revision.
- [ ] Approval cannot consume unaccepted planning revision.
- [ ] Superseded revisions stay queryable.

## Suggested tests

- `test_v2_artifact_revisions.py`
