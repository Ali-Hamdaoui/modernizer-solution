# F15-JOB-038 — Add stage completion gate creation
...
Create a gate when a stage passes under manual policy.
...
- [ ] Bind stage report/final report refs.
- [ ] Expose continue_to_next_stage action.
...
- [ ] Gate created after successful stage.
- [ ] Next stage not queued until continue.
- [ ] No gate on old auto policy unless warnings require.

## Suggested tests

- `test_v2_stage_completion_gate.py`
