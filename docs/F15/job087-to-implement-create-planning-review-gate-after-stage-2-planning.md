# F15-JOB-087 — Create planning_review gate after Stage 2 planning
...
Apply planning review to Stage 2.
...
- [ ] Bind Stage 2 plan artifacts.
- [ ] Use accepted Stage 2 analysis.
- [ ] Create gate.
...
- [ ] Stage 2 approval waits.
- [ ] Artifacts stage-scoped.
- [ ] Plan not mixed with Stage 1.

## Suggested tests

- `test_v2_stage2_planning_review_gate.py`
