# F15-JOB-099 — Add plan reviewer consistency gate
...
Run reviewer/consistency check before accepting revised plan.
...
- [ ] Use existing PlanReviewService where possible.
- [ ] Store reviewer decision.
- [ ] Block unsafe revision.
...
- [ ] Unsafe plan revision cannot be accepted.
- [ ] Reviewer result visible.
- [ ] No automatic apply.

## Suggested tests

- `test_v2_plan_review_gate.py`
