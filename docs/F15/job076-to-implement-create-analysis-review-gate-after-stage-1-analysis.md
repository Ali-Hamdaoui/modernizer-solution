# F15-JOB-076 — Create analysis_review gate after Stage 1 analysis
...
Stop Stage 1 after analysis in F15 manual mode.
...
- [ ] Detect Stage 1 analysis completion.
- [ ] Create analysis_review gate.
- [ ] Bind analysis artifacts.
...
- [ ] Planning not started automatically.
- [ ] Chatbot can explain analysis.
- [ ] Continue starts planning.

## Suggested tests

- `test_v2_stage1_analysis_review_gate.py`
