# F15-JOB-026 — Implement request_reanalysis validation
...
Convert flexible user feedback into a safe re-analysis request.
...
- [ ] Add request_reanalysis handler.
- [ ] Store user feedback and base revision.
- [ ] Create new revision request state.
...
- [ ] Only analysis_review gate accepts action.
- [ ] Downstream planning is blocked/superseded as required.
- [ ] No source writes occur.

## Suggested tests

- `test_v2_reanalysis_request.py`
