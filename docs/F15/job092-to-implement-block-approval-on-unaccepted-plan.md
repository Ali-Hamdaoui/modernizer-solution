# F15-JOB-092 — Block approval on unaccepted plan
...
Ensure approval cannot start from draft/superseded plan.
...
- [ ] Gate guard.
- [ ] Approval service guard.
- [ ] Assistant action guard.
...
- [ ] Draft plan cannot approve.
- [ ] Superseded plan cannot approve.
- [ ] Accepted plan can create approval gate.

## Suggested tests

- `test_v2_approval_requires_accepted_plan.py`
