# F15-JOB-097 — Add planning review UI card
...
Render planning gate and revision request UX.
...
- [ ] Action posts gate endpoint.
- [ ] No YAML direct edit.
- [ ] Chatbot context gate-bound.

## Suggested tests

- `MigrationCockpit planning gate tests`
