# F15-JOB-113 — Add gate API endpoints
...
Expose gate list/open/detail/action endpoints.
...
- [ ] GET gates/open/detail.
- [ ] POST gate actions.
- [ ] Schema forbids paths/argv/env.
...
- [ ] Open gate API returns safe DTO.
- [ ] Action API validates checksum.
