# F15-JOB-036 — Refactor auto-queue behind policy
...
Make `_auto_queue_next_stage()` respect stage_continuation_policy.
...
- [ ] Load job policy.
- [ ] Preserve old auto_on_green behavior.
- [ ] Manual creates stage_completion_review gate.
...
- [ ] Old behavior unchanged with auto_on_green.
- [ ] Manual does not queue next stage.
- [ ] Gate event emitted.
