# F15-JOB-028 — Implement approve_transformation gate action
...
Start transformation only after accepted plan and checksum-bound approval.
...
- [ ] Validate accepted analysis and plan revisions.
- [ ] Queue backend-owned transform command.
...
- [ ] No transform from stale plan.
- [ ] No frontend path accepted.
