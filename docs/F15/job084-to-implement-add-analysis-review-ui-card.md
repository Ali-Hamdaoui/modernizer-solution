# F15-JOB-084 — Add analysis review UI card
...
Render analysis_review gate and actions.
...
- [ ] Show status and artifacts.
- [ ] Buttons: accept, request reanalysis.
...
- [ ] No sandbox_path sent.
- [ ] Actions call gate endpoint.
- [ ] Artifact summary shown.

## Suggested tests

- `MigrationCockpit analysis gate tests`
