# F15-JOB-045 — Add stage skip blocker
...
Block direct Stage 3 start without accepted Stage 2 output.
...
- [ ] Check accepted prior stage completion gate.
- [ ] Return safe error.
...
- [ ] Stage 3 jump blocked.
- [ ] Stage 2 jump requires Stage 1 output.
- [ ] No frontend path override.

## Suggested tests

- `test_v2_stage_skip_blocker.py`
