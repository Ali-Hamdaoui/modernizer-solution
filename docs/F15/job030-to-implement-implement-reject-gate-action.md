# F15-JOB-030 — Implement reject_gate action
...
Allow explicit rejection without side effects.
...
- [ ] Reject gate and persist reason.
...
- [ ] Rejected gate cannot continue.
- [ ] Decision is auditable.
- [ ] No command is queued.

## Suggested tests

- `test_v2_gate_reject.py`
