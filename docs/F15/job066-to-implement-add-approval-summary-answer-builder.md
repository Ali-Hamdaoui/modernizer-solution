# F15-JOB-066 — Add approval summary answer builder
...
Present approval-ready summary with checksum.
...
- [ ] Use approval evidence pack.
- [ ] Show exact checksum and scope.
...
- [ ] Approval summary is checksum-bound.
- [ ] Assistant does not approve by itself.
- [ ] User action required.

## Suggested tests

- `test_v2_assistant_approval_summary.py`
