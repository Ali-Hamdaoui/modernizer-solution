# F15-JOB-051 — Implement gate artifact ref schema
...
Standardize artifact references stored on gates.
...
- [ ] Define artifact kind/path/ref/checksum fields.
- [ ] Support analysis/planning/approval/repair kinds.
- [ ] No raw absolute paths in public DTO.
...
- [ ] Gate refs resolve internally.
- [ ] DTO redacts filesystem details.
- [ ] Missing checksum rejected.

## Suggested tests

- `test_v2_gate_artifact_ref_schema.py`
