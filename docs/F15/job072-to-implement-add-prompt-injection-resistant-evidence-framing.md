# F15-JOB-072 — Add prompt-injection resistant evidence framing

**Area:** Assistant Security  
**Status:** To implement  
...
Ensure artifact content is treated as data, not instructions.
...
- [ ] Update system prompt/gate prompt.
- [ ] Mark evidence as untrusted content.
...
- [ ] Malicious artifact does not trigger action.
- [ ] Assistant warns if artifact contains instructions.
- [ ] Tests include prompt injection.

## Suggested tests

- `test_v2_assistant_prompt_injection.py`
