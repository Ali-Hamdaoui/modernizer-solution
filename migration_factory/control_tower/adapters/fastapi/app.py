    ...
    def create_repair_proposal(
        ...
        return service.proposal_to_dict(proposal) | {
            "proposal_model": {
                ...
                "redacted_error_summary": getattr(proposer_model_result, "redacted_summary", ""),
    ...
    def create_reviewer_critique(
        ...
        return service.critique_to_dict(critique) | {
            "reviewer_model": {
                ...
                "redacted_error_summary": getattr(reviewer_model_result, "redacted_summary", ""),
...
def _repair_candidate_with_review_projection(candidate: dict[str, Any], uow: Any, job_id: str) -> dict[str, Any]:
    ...
    effective_status = _effective_post_repair_verification_status(projected)
    if effective_status:
        projected["post_repair_verification_status"] = effective_status
