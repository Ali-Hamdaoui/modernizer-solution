...
_POLICIES: dict[str, RepairRecipePolicy] = {
    ...
    "JACKSON_PROPERTY_BOM_ALIGNMENT": RepairRecipePolicy(
        recipe_id="recipe-jackson-property-bom-alignment-v1",
        ...
        apply_candidate_allowed=True,
        dry_run_available=True,
        required_evidence=("sandbox", "pom_xml", "dependency_graph", "test_report"),
        forbidden_patterns=("jackson 2.20.0", "spring boot 3.5"),
        verification_requirements=(
        ...
        proof_required=True,
        rag_reuse_enabled=True,
        promotion_notes="Stage-1 Boot 2.7 / Java 11 deterministic POM-only Jackson 2.13.5 alignment. CLI/reference is advisory only.",
    ),
