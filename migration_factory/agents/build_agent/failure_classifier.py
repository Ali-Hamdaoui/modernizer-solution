...
def _classify_failure(
    *,
    ...
    if ("cannot mock" in lower and "final class" in lower) or "cannot mock/spy class" in lower:
    ...
    if "jakarta.validation.constraintviolationexception" in lower and context.get(
        "has_legacy_constraint_handler",
        False,
    ):
