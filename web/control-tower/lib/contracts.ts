...
export type V2RepairApplyCandidateResponse = {
  ...
  policy_validation_checksum?: string;
  review_chain_identity_checksum?: string;
  ...
  downstream_resume_status?: string;
  downstream_command_id?: string;
  downstream_stage_index?: number;
...
export type V2RepairDraftReviewResponse = {
  review_status: string;
  verdict: string;
  reviewer_kind: string;
  reviewer_origin: string;
  llm_invoked: boolean;
  future_llm_reviewer_compatible: boolean;
  reviewed_family: string;
  failure_type: string;
  classification_status: string;
  governance_gate_type: string;
  stage_index: number | null;
