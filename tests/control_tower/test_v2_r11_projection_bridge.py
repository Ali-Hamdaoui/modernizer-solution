...
def test_nested_post_repair_failed_classification_is_not_proof_accepted() -> None:
    candidate = {
        "stage_index": 1,
        "status": "verified",
        "execution_status": "verified",
...
def test_top_level_post_repair_scoped_classification_is_not_proof_accepted() -> None:
    candidate = {
        "stage_index": 1,
        "status": "verified",
        "execution_status": "verified",
