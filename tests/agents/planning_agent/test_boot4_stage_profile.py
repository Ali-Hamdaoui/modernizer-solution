...
def test_boot4_stage_profile_loads_with_expected_target_and_guardrails() -> None:
    ...
    schema = json.loads((AI_HUB / "schemas" / "migration-profile.schema.json").read_text(encoding="utf-8"))
    ...
    assert profile["strategy"] == "staged_openrewrite_sandbox"
...
def test_boot4_stage_catalog_uses_operator_supplied_plugin_and_recipe() -> None:
    ...
    assert catalog["apply_goal"] == "runNoFork"
